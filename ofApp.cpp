...
void ofApp::update() {
	...
	for (int i = 0; i < this->noise_seed_list.size(); i++) {
		...
		this->noise_location_list[i] = glm::vec3(ofMap(ofNoise(this->noise_seed_list[i].x, ofGetFrameNum() * 0.008), 0, 1, -350, 350), ofMap(ofNoise(this->noise_seed_list[i].y, ofGetFrameNum() * 0.008), 0, 1, -350, 350), 0);
